...
mixin _$CounterState {
  CounterStateEnum? get counterStateEnum => throw _privateConstructorUsedError;
...
abstract class $CounterStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({CounterStateEnum? counterStateEnum});
}
...
class _$CounterStateCopyWithImpl<$Res, $Val extends CounterState>
  ...
  @override
  $Res call({
    Object? counterStateEnum = freezed,
  }) {
    return _then(_value.copyWith(
      counterStateEnum: freezed == counterStateEnum
          ? _value.counterStateEnum
          : counterStateEnum // ignore: cast_nullable_to_non_nullable
              as CounterStateEnum?,
    ) as $Val);
  }
}
...
class _$CounterStateImpl implements _CounterState {
  const _$CounterStateImpl({required this.counterStateEnum});

  factory _$CounterStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$CounterStateImplFromJson(json);

  @override
  final CounterStateEnum? counterStateEnum;

  @override
  String toString() {
    return 'CounterState(counterStateEnum: $counterStateEnum)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.counterStateEnum, counterStateEnum) ||
                other.counterStateEnum == counterStateEnum));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, counterStateEnum);
...
abstract class _CounterState implements CounterState {
  const factory _CounterState(
      {required final CounterStateEnum? counterStateEnum}) = _$CounterStateImpl;

  factory _CounterState.fromJson(Map<String, dynamic> json) =
      _$CounterStateImpl.fromJson;

  @override
  CounterStateEnum? get counterStateEnum;
  @override
  @JsonKey(ignore: true)
  _$$CounterStateImplCopyWith<_$CounterStateImpl> get copyWith =>
      throw _privateConstructorUsedError;
