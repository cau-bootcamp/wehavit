...
class NotificationRepositoryImpl extends NotificationRepository {
  ...
  Future<void> sendNotification({
    ...
    final jsonCredentials = await rootBundle.loadString('.env/we-havit-be-111008c5229d.json');
    ...
    for (var token in targetTokenList) {
      var response = await client.post(
        Uri.parse('https://fcm.googleapis.com/v1/projects/764897522660/messages:send'),
