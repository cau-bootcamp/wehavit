...
_$FirebaseResolutionModelImpl _$$FirebaseResolutionModelImplFromJson(Map<String, dynamic> json) =>
    _$FirebaseResolutionModelImpl(
      ...
      shareFriendIdList: (json['shareFriendIdList'] as List<dynamic>?)?.map((e) => e as String).toList(),
      shareGroupIdList: (json['shareGroupIdList'] as List<dynamic>?)?.map((e) => e as String).toList(),
...
Map<String, dynamic> _$$FirebaseResolutionModelImplToJson(_$FirebaseResolutionModelImpl instance) => <String, dynamic>{
